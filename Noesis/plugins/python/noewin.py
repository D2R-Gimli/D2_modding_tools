import noesis
from ctypes import windll, Structure, sizeof, WINFUNCTYPE, pointer, byref, c_uint, c_int, c_long, c_ushort, c_char, c_void_p, create_unicode_buffer, cast, POINTER
from ctypes.wintypes import HWND, HINSTANCE, HANDLE, HDC, HBRUSH, HPEN, LPCWSTR, WPARAM, LPARAM, MSG, LPMSG, RECT, LPRECT, POINT, LPPOINT, BOOL, COLORREF
LRESULT = LPARAM
...
user32.LoadCursorW.argtypes = [HANDLE, HANDLE]
...
gdi32.Rectangle.argtypes = [HDC, c_int, c_int, c_int, c_int]
gdi32.MoveToEx.argtypes = [HDC, c_int, c_int, LPPOINT]
gdi32.LineTo.argtypes = [HDC, c_int, c_int]
gdi32.BitBlt.argtypes = [HDC, c_int, c_int, c_int, c_int, HDC, c_int, c_int, c_uint]
gdi32.Ellipse.argtypes = [HDC, c_int, c_int, c_int, c_int]
...
gdi32.CreateBitmap.argtypes = [c_int, c_int, c_uint, c_uint, HANDLE]
gdi32.CreateSolidBrush.restype = HBRUSH
gdi32.CreateSolidBrush.argtypes = [COLORREF]
gdi32.CreatePen.restype = HPEN
gdi32.CreatePen.argtypes = [c_int, c_int, COLORREF]
user32.DrawTextW.argtypes = [HANDLE, LPCWSTR, c_int, LPRECT, c_uint]
user32.CreateWindowExW.restype = HANDLE
user32.CreateWindowExW.argtypes = [c_uint, c_void_p, c_void_p, c_uint, c_int, c_int, c_int, c_int, HANDLE, HANDLE, HANDLE, HANDLE]
user32.DefWindowProcW.restype = LRESULT
user32.DefWindowProcW.argtypes = [HWND, c_uint, WPARAM, LPARAM]
user32.DispatchMessageW.restype = LRESULT
user32.SetTimer.argtypes = [HWND, WPARAM, c_uint, HANDLE]
user32.SendMessageW.restype = LRESULT
user32.SendMessageW.argtypes = [HWND, c_uint, WPARAM, c_void_p]
user32.UnregisterClassW.argtypes = [LPCWSTR, HINSTANCE]
user32.InvalidateRect.argtypes = [HWND, HANDLE, BOOL]
kernel32.GetModuleHandleW.restype = HANDLE
kernel32.GetModuleHandleW.argtypes = [HANDLE]
user32.GetMessageW.argtypes = [LPMSG, HWND, c_uint, c_uint]
